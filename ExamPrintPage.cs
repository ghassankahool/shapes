...
namespace shapes
{
    class ExamPrintPage : PrintDocument
    {
        ...
        void drawBox(Graphics g, int row, int col)
        {
            ...
            if (s == 100)
            {
                g.DrawString(rn, font8, Brushes.Red, num, format1);
            }
            else
            {
            ...
            g.DrawString("د", font, Brushes.Red, d, format1);


            g.DrawArc(Pens.LightGray, c, 0, 360);
            g.DrawString("جـ", font, Brushes.Red, c, format1);


            g.DrawArc(Pens.LightGray, b, 0, 360);
            g.DrawString("ب", font, Brushes.Red, b, format1);


            g.DrawArc(Pens.LightGray, a, 0, 360);
            g.DrawString("ا", font, Brushes.Red, a, format1);


            g.DrawArc(Pens.LightGray, h, 0, 360);
            g.DrawString("هـ", font, Brushes.Red, h, format1);
        ...
        void drawNum(Graphics g, int row)
        {
            ...
            g.DrawString("8", font, Brushes.Red, _8, format1);


            g.DrawArc(Pens.LightGray, _7, 0, 360);
            g.DrawString("7", font, Brushes.Red, _7, format1);


            g.DrawArc(Pens.LightGray, _6, 0, 360);
            g.DrawString("6", font, Brushes.Red, _6, format1);


            g.DrawArc(Pens.LightGray, _5, 0, 360);
            g.DrawString("5", font, Brushes.Red, _5, format1);


            g.DrawArc(Pens.LightGray, _9, 0, 360);
            g.DrawString("9", font, Brushes.Red, _9, format1);

            g.DrawArc(Pens.LightGray, _4, 0, 360);
            g.DrawString("4", font, Brushes.Red, _4, format1);

            g.DrawArc(Pens.LightGray, _3, 0, 360);
            g.DrawString("3", font, Brushes.Red, _3, format1);

            g.DrawArc(Pens.LightGray, _2, 0, 360);
            g.DrawString("2", font, Brushes.Red, _2, format1);

            g.DrawArc(Pens.LightGray, _1, 0, 360);
            g.DrawString("1", font, Brushes.Red, _1, format1);

            g.DrawArc(Pens.LightGray, _0, 0, 360);
            g.DrawString("0", font, Brushes.Red, _0, format1);
